...
cd ../SourceFiles
g++ -std=c++11 -c adventure.cpp AttackCommand.cpp Game.cpp Gold.cpp GoldFactory.cpp Player.cpp GameObject.cpp CommandFactory.cpp MoveCommand.cpp Room.cpp Silver.cpp SilverFactory.cpp -I ../HeaderFiles
